...
export type GetThreadActivityOrgQuery = {
  __typename?: 'query_root'
  org: Array<{ __typename?: 'org'; id: string }>
}

export type GetQuantityQueryVariables = Exact<{
  orgId: Scalars['uuid']
}>

export type GetQuantityQuery = {
  __typename?: 'query_root'
  org_by_pk?: {
    __typename?: 'org'
    id: string
...
export const GetThreadActivityDataDocument = {
  ...
  definitions: [
    ...
    ...ThreadActivityFragmentDoc.definitions,
    ...OrgFragmentDoc.definitions,
  ],
} as unknown as DocumentNode<
...
>
export const GetThreadActivityOrgDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getThreadActivityOrg' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  GetThreadActivityOrgQuery,
  GetThreadActivityOrgQueryVariables
>
export const GetQuantityDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getQuantity' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
} as unknown as DocumentNode<GetQuantityQuery, GetQuantityQueryVariables>
