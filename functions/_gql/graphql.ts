...
export type GetRecipientsQuery = { __typename?: 'query_root', member: Array<{ __typename?: 'member', id: string, name: string, user?: { __typename?: 'users', id: string, locale: string } | null }> };
...
export type GetMeetingDataQuery = { __typename?: 'query_root', meeting_by_pk?: { __typename?: 'meeting', id: string, title: string, attendees?: Array<MeetingAttendee> | null, org: { __typename?: 'org', id: string, name: string, archived: boolean, createdAt: string, defaultWorkedMinPerWeek: number, slug?: string | null }, circle: { __typename?: 'circle', role: { __typename?: 'role', name: string } } } | null };
