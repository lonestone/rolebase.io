...
export const TaskNotificationDataFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'TaskNotificationData' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'task' },
      },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'FragmentSpread', name: { kind: 'Name', value: 'Task' } },
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'org' },
            selectionSet: {
...
} as unknown as DocumentNode<TaskNotificationDataFragment, unknown>
...
} as unknown as DocumentNode<GetOrgQuery, GetOrgQueryVariables>
...
export const GetTaskDataDocument = {
  ...
  definitions: [
    ...
    ...TaskNotificationDataFragmentDoc.definitions,
  ],
