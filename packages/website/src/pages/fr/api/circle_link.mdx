...
<ApiReference title="Lien de cercle" entity="circle_link" description="Représente un lien entre deux cercles, permettant la collaboration transversale et la représentation d'un cercle au sein d'un autre au-delà de la hiérarchie parent-enfant.">
