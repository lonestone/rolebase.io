...
<ApiReference title="Cercle" entity="circle" description="Représente un cercle organisationnel hiérarchique pouvant contenir des membres, des rôles et des cercles enfants. Les cercles organisent les équipes et les responsabilités au sein d'une organisation.">
