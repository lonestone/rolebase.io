...
<ApiReference title="Membre de cercle" entity="circle_member" description="Représente une relation d'appartenance entre un membre et un cercle, avec suivi du statut d'association et de l'historique.">
