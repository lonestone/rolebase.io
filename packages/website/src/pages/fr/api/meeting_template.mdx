...
<ApiReference title="Modèle de réunion" entity="meeting_template" description="Une configuration de réunion réutilisable qui définit la structure et le déroulement des réunions, aidant les organisations à standardiser leurs formats de réunion.">
