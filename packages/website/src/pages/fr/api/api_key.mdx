...
<ApiReference title="Clé API" entity="api_key" description="Représente une clé API pour l'accès programmatique à l'API Rolebase. Les clés API authentifient et autorisent l'intégration avec des applications et services externes.">
