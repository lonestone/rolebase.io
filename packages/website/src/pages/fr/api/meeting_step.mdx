...
<ApiReference title="Étape de réunion" entity="meeting_step" description="Représente une étape spécifique ou un point de l'ordre du jour au sein d'une réunion, utilisée pour structurer les réunions et suivre la progression à travers des activités comme les notes, discussions, listes de vérification et tâches.">
...
<EntityFields fields={[
  ...
  { name: "stepConfigId", type: "String", description: "Référence à la configuration de l'étape dans le stepsConfig de la réunion" },
  { name: "type", type: "Meeting_Step_Type_Enum", description: "Type d'étape de réunion" },
  { name: "data", type: "meeting_step_data", description: "Données et contenu spécifiques à l'étape" },
  { name: "notes", type: "String", description: "Notes et documentation de l'étape" },
]} />
