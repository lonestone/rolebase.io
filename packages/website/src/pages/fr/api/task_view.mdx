...
<ApiReference title="Vue de tâche" entity="task_view" description="Représente une vue personnalisée des tâches dans Rolebase. Les vues de tâches permettent aux utilisateurs d'organiser et de filtrer les tâches de manière flexible, supportant différentes méthodologies de gestion comme Kanban ou Scrum.">
...
- Les membres de l'organisation avec les rôles **Member**, **Admin** ou **Owner** peuvent :
  - Créer des vues de tâches
  - Consulter les vues de tâches
  - Mettre à jour les vues de tâches auxquelles ils ont accès
