...
<ApiReference title="Discussion" entity="thread" description="Représente une discussion ou un fil de conversation dans Rolebase. Les discussions sont associées à des cercles, supportent des activités (messages), des réactions, des membres supplémentaires, et peuvent référencer des tâches, réunions et décisions.">

## Champs

<EntityFields fields={[
  { name: "id", type: "uuid", description: "Identifiant unique de la discussion (généré automatiquement)" },
  { name: "orgId", type: "uuid", description: "Référence à l'organisation" },
  { name: "circleId", type: "uuid", description: "Référence au cercle" },
  { name: "initiatorMemberId", type: "uuid", description: "Référence au membre qui a initié la discussion" },
  { name: "title", type: "String", description: "Titre de la discussion" },
  { name: "createdAt", type: "Timestamp", description: "Date de création de la discussion (par défaut : horodatage actuel)" },
  { name: "archived", type: "Boolean", description: "Indique si la discussion est archivée (par défaut : false)" },
  { name: "private", type: "Boolean", description: "Indique si la discussion est privée (par défaut : false)" },
  { name: "status", type: "Thread_Status_Enum", description: "Statut actuel de la discussion (ex. : Active, Preparation, Closed)" },
]} />
