...
<ApiReference title="Réunion récurrente" entity="meeting_recurring" description="Définit la planification, le modèle et les paramètres d'une série de réunions récurrentes au sein d'un cercle.">

## Champs

<EntityFields fields={[
  { name: "id", type: "uuid", description: "Identifiant unique de la configuration récurrente" },
  { name: "orgId", type: "uuid", description: "Référence à l'organisation" },
  { name: "circleId", type: "uuid", description: "Référence au cercle" },
  { name: "templateId", type: "uuid", description: "Référence au modèle de réunion" },
  { name: "rrule", type: "String", description: "Règle de récurrence au format iCal (RFC 5545)" },
  { name: "duration", type: "Smallint", description: "Durée de la réunion en minutes" },
  { name: "scope", type: "participants_scope", description: "Configuration pour la sélection des participants" },
  { name: "private", type: "Boolean", description: "Indique si les réunions de la série sont privées (par défaut : false)" },
  { name: "invitedReadonly", type: "Boolean", description: "Indique si les membres invités sont en lecture seule (par défaut : false)" },
  { name: "videoConf", type: "JSON", description: "Paramètres de visioconférence par défaut (optionnel)" },
  { name: "createdAt", type: "Timestamp", description: "Date de création de la configuration récurrente" },
]} />
