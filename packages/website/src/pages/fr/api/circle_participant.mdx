...
<ApiReference title="Participant de cercle" entity="circle_participant" description="Une vue calculée représentant tous les participants d'un cercle, incluant les membres directs et les participants hérités des cercles enfants et liés.">
...
<EntityFields fields={[
  { name: "id", type: "uuid", description: "Identifiant unique de l'entrée de cache du participant" },
...
### Obtenir les participants d'un cercle spécifique
