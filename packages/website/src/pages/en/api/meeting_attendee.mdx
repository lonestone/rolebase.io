...
<ApiReference title="Meeting Attendee" entity="meeting_attendee" description="Tracks a member's participation in a meeting, including presence status and notification state.">

## Fields

<EntityFields fields={[
  { name: "id", type: "uuid", description: "Unique identifier for the attendee record" },
  { name: "meetingId", type: "uuid", description: "Reference to the meeting" },
  { name: "memberId", type: "uuid", description: "Reference to the member" },
  { name: "present", type: "Boolean", description: "Whether the member is present in the meeting (optional)" },
  { name: "startNotified", type: "Boolean", description: "Whether a start notification was sent (default: false)" },
]} />
