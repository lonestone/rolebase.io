...
<ApiReference title="Decision" entity="decision" description="Represents a formal decision made within a circle. Decisions track important choices, policies, and agreements, and can be referenced in threads and other entities for documentation.">
...
- **Modification rights** — Only the original decision maker and circle leaders can modify decisions
