...
<ApiReference title="Organization File" entity="org_file" description="Represents an association between an organization and a file, enabling organization-level file management and access control.">
