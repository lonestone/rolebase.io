...
<ApiReference title="Task View" entity="task_view" description="Represents a custom view of tasks in Rolebase. Task views allow users to organize and filter tasks flexibly, supporting different task management methodologies like Kanban or Scrum.">
...
- Organization members with **Member**, **Admin**, or **Owner** roles can:
  - Create task views
  - View task views
