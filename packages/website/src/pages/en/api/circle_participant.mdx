...
<ApiReference title="Circle Participant" entity="circle_participant" description="A computed view representing all participants in a circle, including direct members and inherited participants from child and linked circles.">
