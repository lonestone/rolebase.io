...
<ApiReference title="Thread Extra Member" entity="thread_extra_member" description="Represents an additional member invited to participate in a thread beyond the default circle participants. Enables cross-circle collaboration by extending thread access.">
