...
> ***Représenter EVEA visuellement et simplement revenait à explorer les méandres d'une rivière inconnue avec une carte dessinée à la main.***
...
> ***Pour mon rôle de responsable de la communication externe et interne, Rolebase est devenu un outil indispensable pour présenter EVEA sous tous ses angles, même devant des partenaires, des clients, ou au cours du processus de recrutement.***
