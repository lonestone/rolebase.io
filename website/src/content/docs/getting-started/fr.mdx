...
<Callout type="tip" title="Suggestions par IA">
  Rolebase peut générer des suggestions de rôles par IA. À partir de la raison
  d'être du rôle parent, l'IA propose des sous-rôles avec raison d'être, domaine
  et redevabilités pré-remplis.
</Callout>
...
<Callout type="info" title="Invitations en attente">
  Les invitations sont automatiquement renvoyées avec une fréquence décroissante
  jusqu'à ce qu'elles soient acceptées. Vous pouvez suivre leur statut depuis la
  liste des membres.
</Callout>
