---
title: 'Réunions'
description: 'Créez, animez et gérez des réunions structurées au sein de vos rôles.'
---
...
<Callout type="tip" title="Ordre des étapes">
  L'ordre par défaut (Tour de parole, Liste de contrôle, Indicateurs, Tâches,
  Discussions) suit le format de réunion tactique holacratique, mais vous pouvez
  réordonner, ajouter ou supprimer des étapes pour répondre aux besoins de votre
  équipe.
</Callout>
...
<Callout type="tip" title="Résumé IA">
  ...
  récapitulatif concis des discussions et décisions pour les membres qui étaient
  absents.
</Callout>
