---
title: 'Decisions'
description: 'Record formal decisions and governance changes within your roles.'
---
...
<Callout type="tip" title="Be Specific">
  Good decision records include the context (why), the resolution (what), and
  any scope or time limits. This makes them valuable for future reference.
</Callout>
...
<Callout type="info" title="Governance Protection">
  When **Protect Governance** is enabled in [organization
  settings](/en/docs/organizations), structural changes can only be made by role
  leaders. Decisions serve as the record of approved governance changes.
</Callout>
