---
title: 'Import'
description: 'Migrate your organizational structure from Holaspirit and other tools.'
order: 13
---
...
<Callout type="warning" title="Existing Data">
  Importing into an organization that already has roles may create duplicates.
  It is recommended to import into a fresh organization.
</Callout>
...
<Callout type="info" title="User Accounts">
  Imported members are created as entries without linked user accounts. You will
  need to [invite them via email](/en/docs/members) so they can log in and
