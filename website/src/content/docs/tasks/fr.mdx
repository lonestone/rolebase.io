---
title: 'Tâches'
description: 'Suivez les éléments de travail avec des tableaux kanban et des vues en liste.'
order: 7
---
...
<Callout type="tip" title="Tâches du tableau de bord">
  Votre tableau de bord personnel affiche les tâches qui vous sont assignées
  dans tous les rôles, vous offrant un endroit unique pour voir tout ce que vous
  avez à faire.
</Callout>
