...
<Callout type="tip" title="Use a Template">
  Click **Use a template** in the title field to load a pre-configured meeting
  structure. Templates save time for recurring formats like tactical or
  governance meetings.
</Callout>
...
<Callout type="info" title="Video Conferencing">
  If a video conference link is configured, a button to join the call appears
...
<Callout type="tip" title="AI Summary">
  Meeting summaries can be auto-generated, providing a concise recap for members
  who were absent.
</Callout>
