...
<EntityFields
  fields={[
    ...
    },
    {
      name: 'orgId',
      type: 'uuid',
      description: 'Reference to the organization this task belongs to',
    },
    {
      name: 'circleId',
      type: 'uuid',
      description: 'Reference to the circle this task is associated with',
    },
    {
      name: 'memberId',
      type: 'uuid',
      description: 'Reference to the assigned member (optional)',
    },
    ...
    },
    {
      name: 'createdAt',
      type: 'Timestamp',
      description: 'When the task was created (defaults to current timestamp)',
    },
    {
      name: 'archived',
      type: 'Boolean',
      description: 'Whether the task is archived (defaults to false)',
    },
    {
      name: 'private',
      type: 'Boolean',
      description: 'Whether the task is private (defaults to false)',
    },
  ]}
/>
