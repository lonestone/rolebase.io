  ...
  fields={[
    {
      name: 'id',
      type: 'uuid',
      description: 'Unique identifier for the attendee record',
    },
    {
      name: 'meetingId',
      type: 'uuid',
    ...
    { name: 'memberId', type: 'uuid', description: 'Reference to the member' },
    {
      name: 'present',
      type: 'Boolean',
      description: 'Whether the member is present in the meeting (optional)',
    },
    {
      name: 'startNotified',
      type: 'Boolean',
      description: 'Whether a start notification was sent (default: false)',
    },
  ]}
/>
