  ...
  fields={[
    {
      name: 'id',
      type: 'uuid',
      description: "Identifiant unique de l'enregistrement de participation",
    },
    ...
    { name: 'memberId', type: 'uuid', description: 'Référence au membre' },
    {
      name: 'present',
      type: 'Boolean',
      description: 'Indique si le membre est présent à la réunion (optionnel)',
    },
    {
      name: 'startNotified',
      type: 'Boolean',
...
<Callout type="info" title="Notes">
  Chaque membre ne peut apparaître qu'une seule fois par réunion (imposé par la
  contrainte d'unicité). Le champ `present` est optionnel et peut être mis à
  jour pendant la réunion. La suppression d'une réunion ou d'un membre supprime
  automatiquement les enregistrements de présence associés.
</Callout>
