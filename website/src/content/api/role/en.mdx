...
<EntityFields
  fields={[
    ...
    { name: 'name', type: 'String', description: 'Name of the role' },
    {
      name: 'purpose',
      type: 'String',
      description: "The role's purpose or mission",
    },
    {
      name: 'domain',
      type: 'String',
      description: 'Areas of authority and control',
    },
    {
    ...
    },
    {
      name: 'checklist',
      type: 'String',
      description: 'Checklist of recurring responsibilities',
    },
    {
      name: 'indicators',
      type: 'String',
    ...
    { name: 'notes', type: 'String', description: 'Additional notes' },
    {
      name: 'archived',
      type: 'Boolean',
      description: 'Whether the role is archived (default: false)',
    },
    {
      name: 'base',
      type: 'Boolean',
      description: 'Whether this is a base role (default: false)',
    },
    {
      name: 'singleMember',
      type: 'Boolean',
      description: 'Whether the role can only have one member (default: false)',
    },
    {
      name: 'parentLink',
      type: 'Boolean',
    ...
    },
    {
      name: 'colorHue',
      type: 'Smallint',
      description: 'Color hue for visual representation (optional)',
    },
  ]}
/>
