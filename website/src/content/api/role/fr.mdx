...
<EntityFields
  fields={[
    ...
    { name: 'name', type: 'String', description: 'Nom du rôle' },
    {
      name: 'purpose',
      type: 'String',
      description: "Raison d'être ou mission du rôle",
    },
    {
      name: 'domain',
      type: 'String',
      description: "Domaines d'autorité et de contrôle",
    },
    {
      name: 'accountabilities',
      type: 'String',
      description: 'Liste des redevabilités',
    },
    {
      name: 'checklist',
      type: 'String',
      description: 'Liste de vérification des responsabilités récurrentes',
    },
    {
      name: 'indicators',
      type: 'String',
      description: 'Indicateurs de performance à suivre',
    },
    { name: 'notes', type: 'String', description: 'Notes supplémentaires' },
    {
      name: 'archived',
      type: 'Boolean',
      description: 'Indique si le rôle est archivé (par défaut : false)',
    },
    {
      name: 'base',
      type: 'Boolean',
      description: "Indique si c'est un rôle de base (par défaut : false)",
    },
    {
      name: 'singleMember',
      type: 'Boolean',
      description:
        "Indique si le rôle ne peut avoir qu'un seul membre (par défaut : false)",
    },
    {
      name: 'parentLink',
      type: 'Boolean',
      description:
        'Indique si le rôle peut être lié aux cercles parents (par défaut : false)',
    },
    {
      name: 'colorHue',
      type: 'Smallint',
      description:
        'Teinte de couleur pour la représentation visuelle (optionnel)',
    },
  ]}
/>
