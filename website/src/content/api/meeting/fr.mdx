...
<EntityFields
  fields={[
    ...
    { name: 'title', type: 'String', description: 'Titre de la réunion' },
    {
      name: 'summary',
      type: 'String',
      description: 'Résumé ou notes de la réunion',
    },
    {
      name: 'startDate',
      type: 'Timestamp',
    ...
    },
    {
      name: 'createdAt',
      type: 'Timestamp',
      description: 'Date de création de la réunion',
    },
    {
      name: 'ended',
      type: 'Boolean',
      description: 'Indique si la réunion est terminée (par défaut : false)',
    },
    {
      name: 'archived',
      type: 'Boolean',
      description: 'Indique si la réunion est archivée (par défaut : false)',
    },
    {
      name: 'private',
      type: 'Boolean',
      description: 'Indique si la réunion est privée (par défaut : false)',
    },
    {
    ...
    },
    {
      name: 'currentStepId',
      type: 'uuid',
      description: "ID de l'étape active actuelle (optionnel)",
    },
    {
      name: 'stepsConfig',
      type: '[meeting_step_config]',
      description:
        'Tableau de configuration définissant la structure de la réunion',
    },
    {
      name: 'videoConf',
      type: 'videoconf',
      description: 'Détails de la visioconférence (optionnel)',
    },
    {
      name: 'recurringId',
      type: 'uuid',
      description:
        'Référence à la configuration de réunion récurrente (optionnel)',
    },
    {
      name: 'recurringDate',
      type: 'Timestamp',
      description: 'Date dans la série récurrente (optionnel)',
    },
  ]}
/>
