...
<EntityFields
  fields={[
    ...
    { name: 'title', type: 'String', description: 'Title of the meeting' },
    {
      name: 'summary',
      type: 'String',
      description: 'Summary or notes from the meeting',
    },
    {
      name: 'startDate',
      type: 'Timestamp',
    ...
    },
    {
      name: 'ended',
      type: 'Boolean',
      description: 'Whether the meeting has ended (default: false)',
    },
    {
      name: 'archived',
      type: 'Boolean',
      description: 'Whether the meeting is archived (default: false)',
    },
    {
      name: 'private',
      type: 'Boolean',
      description: 'Whether the meeting is private (default: false)',
    },
    {
      name: 'invitedReadonly',
      type: 'Boolean',
      description: 'Whether invited members are read-only (default: false)',
    },
    {
      name: 'currentStepId',
      type: 'uuid',
      description: 'ID of the current active step (optional)',
    },
    {
      name: 'stepsConfig',
      type: '[meeting_step_config]',
      description: 'Configuration array defining the meeting structure',
    },
    {
      name: 'videoConf',
      type: 'videoconf',
      description: 'Video conferencing details (optional)',
    },
    {
      name: 'recurringId',
      type: 'uuid',
      description:
        'Reference to the recurring meeting configuration (optional)',
    },
    {
      name: 'recurringDate',
      type: 'Timestamp',
      description: 'Date in the recurring series (optional)',
    },
  ]}
/>
