...
<Callout type="info" title="Notes">
  Les modèles peuvent être utilisés pour des réunions ponctuelles et
  récurrentes. L'ordre des étapes dans `stepsConfig` détermine le déroulement de
  la réunion. Les modifications d'un modèle n'affectent pas les réunions
  existantes déjà créées à partir de celui-ci.
</Callout>
