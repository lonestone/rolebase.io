...
<EntityFields
  fields={[
    ...
    { name: 'orgId', type: 'uuid', description: "Référence à l'organisation" },
    {
      name: 'roleId',
      type: 'uuid',
      description: 'Référence au rôle associé à ce cercle',
    },
    {
      name: 'parentId',
      type: 'uuid',
      description:
        'Référence au cercle parent (optionnel, null pour les cercles de premier niveau)',
    },
    {
      name: 'archived',
      type: 'Boolean',
      description: 'Indique si le cercle est archivé (par défaut : false)',
    },
  ]}
/>
