...
<EntityFields
  fields={[
    ...
    },
    {
      name: 'memberName',
      type: 'String',
      description: 'Name of the member (preserved for deleted members)',
    },
    {
      name: 'createdAt',
      type: 'Timestamp',
    ...
    },
    {
      name: 'display',
      type: 'JSON',
      description: 'Type of log and data to display in the UI',
    },
    {
      name: 'changes',
      type: 'JSON',
      description: 'Structured log of entity changes for undo/redo',
    },
    {
      name: 'canceled',
      type: 'Boolean',
    ...
    },
    {
      name: 'cancelLogId',
      type: 'uuid',
      description: 'Reference to the log entry that was canceled (optional)',
    },
    {
      name: 'cancelMemberId',
      type: 'uuid',
      description: 'Member who canceled the action (optional)',
    },
    {
      name: 'cancelMemberName',
      type: 'String',
      description: 'Name of the member who canceled (optional)',
    },
    {
      name: 'meetingId',
      type: 'uuid',
      description: 'Meeting during which this log was created (optional)',
    },
    {
      name: 'taskId',
      type: 'uuid',
      description: 'Task associated with this log (optional)',
    },
    {
      name: 'threadId',
      type: 'uuid',
      description: 'Thread associated with this log (optional)',
    },
  ]}
/>
