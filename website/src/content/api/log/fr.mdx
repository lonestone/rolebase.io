...
<EntityFields
  fields={[
    ...
    },
    {
      name: 'memberId',
      type: 'uuid',
      description: 'Membre qui a effectué la modification',
    },
    {
      name: 'memberName',
      type: 'String',
      description: 'Nom du membre (conservé pour les membres supprimés)',
    },
    {
      name: 'createdAt',
      type: 'Timestamp',
    ...
    },
    {
      name: 'display',
      type: 'JSON',
      description: "Type de journal et données à afficher dans l'interface",
    },
    {
      name: 'changes',
      type: 'JSON',
    ...
    },
    {
      name: 'cancelMemberId',
      type: 'uuid',
      description: "Membre qui a annulé l'action (optionnel)",
    },
    {
      name: 'cancelMemberName',
      type: 'String',
      description: 'Nom du membre qui a annulé (optionnel)',
    },
    {
      name: 'meetingId',
      type: 'uuid',
      description: 'Réunion pendant laquelle ce journal a été créé (optionnel)',
    },
    {
      name: 'taskId',
      type: 'uuid',
      description: 'Tâche associée à ce journal (optionnel)',
    },
    {
      name: 'threadId',
      type: 'uuid',
      description: 'Discussion associée à ce journal (optionnel)',
    },
  ]}
/>
