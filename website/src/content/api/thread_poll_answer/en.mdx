  ...
  fields={[
    {
      name: 'id',
      type: 'uuid',
      description: 'Unique identifier for the poll answer (auto-generated)',
    },
    {
      name: 'activityId',
      type: 'uuid',
      description: 'Reference to the thread activity (poll)',
    },
    {
      name: 'userId',
      type: 'uuid',
      description: 'Reference to the user who submitted the answer',
    },
    {
      name: 'choicesPoints',
      type: 'Int[]',
      description: 'Array of integer points assigned to each poll choice',
    },
    {
      name: 'createdAt',
      type: 'Timestamp',
