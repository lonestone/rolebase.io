  ...
  fields={[
    {
      name: 'id',
      type: 'uuid',
      description: 'Identifiant unique du lien de cercle',
    },
    { name: 'parentId', type: 'uuid', description: 'Référence au cercle hôte' },
    {
      name: 'circleId',
      type: 'uuid',
      description: 'Référence au cercle invité',
    },
    {
      name: 'createdAt',
      type: 'Timestamp',
      description: 'Date de création du lien de cercle',
    },
  ]}
/>
...
<Callout type="info" title="Notes">
  La combinaison de `parentId` et `circleId` doit être unique. Les liens de
  cercle affectent l'héritage des participants et les structures de permissions.
  Les leaders des cercles liés obtiennent certaines permissions dans le cercle
  hôte.
</Callout>
