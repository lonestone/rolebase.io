  ...
  fields={[
    {
      name: 'id',
      type: 'uuid',
      description: 'Unique identifier for the circle link',
    },
    {
      name: 'parentId',
      type: 'uuid',
      description: 'Reference to the hosting circle',
    },
    {
      name: 'circleId',
      type: 'uuid',
      description: 'Reference to the invited circle',
    },
    {
      name: 'createdAt',
      type: 'Timestamp',
      description: 'When the circle link was created',
    },
  ]}
/>
