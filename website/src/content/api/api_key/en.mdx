  ...
  fields={[
    {
      name: 'id',
      type: 'uuid',
      description: 'Unique identifier for the API key (auto-generated)',
    },
    {
      name: 'userId',
      type: 'uuid',
      description: 'Reference to the user who owns this key',
    },
    {
      name: 'name',
      type: 'String',
...
<Callout type="info">
  The key `value` is only shown once upon creation — store it securely. Best
  practices include regularly rotating keys, monitoring usage, deleting unused
  keys, and never sharing them publicly.
</Callout>
