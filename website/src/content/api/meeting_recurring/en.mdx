  ...
  fields={[
    {
      name: 'id',
      type: 'uuid',
      description: 'Unique identifier for the recurring configuration',
    },
    {
      name: 'orgId',
      type: 'uuid',
    ...
    { name: 'circleId', type: 'uuid', description: 'Reference to the circle' },
    {
      name: 'templateId',
      type: 'uuid',
      description: 'Reference to the meeting template',
    },
    {
      name: 'rrule',
      type: 'String',
      description: 'iCal (RFC 5545) format recurrence rule',
    },
    {
      name: 'duration',
      type: 'Smallint',
    ...
    },
    {
      ...
      description: 'Configuration for participant selection',
    },
    {
      name: 'private',
      type: 'Boolean',
    ...
    },
    {
      name: 'videoConf',
      type: 'JSON',
      description: 'Default video conferencing settings (optional)',
    },
    {
      name: 'createdAt',
      type: 'Timestamp',
      description: 'When the recurring configuration was created',
    },
  ]}
/>
