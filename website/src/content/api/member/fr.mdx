...
<EntityFields
  fields={[
    ...
    { name: 'name', type: 'String', description: "Nom d'affichage du membre" },
    {
      name: 'description',
      type: 'String',
      description: 'Description ou biographie du membre',
    },
    {
      name: 'archived',
      type: 'Boolean',
      description: 'Indique si le membre est archivé (par défaut : false)',
    },
    {
      name: 'picture',
      type: 'String',
      description: 'URL de la photo de profil du membre (optionnel)',
    },
    {
      name: 'pictureFileId',
      type: 'uuid',
      description: 'Référence au fichier de photo de profil stocké (optionnel)',
    },
    {
      name: 'userId',
      type: 'uuid',
      description: 'Référence au compte utilisateur associé (optionnel)',
    },
    {
      name: 'inviteEmail',
      type: 'String',
      description: "Adresse e-mail utilisée pour l'invitation (optionnel)",
    },
    {
      name: 'inviteDate',
      type: 'Timestamp',
      description: "Date d'envoi de l'invitation (optionnel)",
    },
    {
      name: 'role',
      type: 'Member_Role_Enum',
      description:
