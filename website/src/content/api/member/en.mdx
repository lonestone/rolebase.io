...
<EntityFields
  fields={[
    ...
    { name: 'name', type: 'String', description: 'Display name of the member' },
    {
      name: 'description',
      type: 'String',
      description: 'Description or bio of the member',
    },
    {
      name: 'archived',
      type: 'Boolean',
      description: 'Whether the member is archived (default: false)',
    },
    {
      name: 'picture',
      type: 'String',
      description: "URL of the member's profile picture (optional)",
    },
    {
      name: 'pictureFileId',
      type: 'uuid',
      description: 'Reference to the stored profile picture file (optional)',
    },
    {
      name: 'userId',
      type: 'uuid',
      description: 'Reference to the associated user account (optional)',
    },
    {
      name: 'inviteEmail',
      type: 'String',
      description: 'Email address used for invitation (optional)',
    },
    {
      name: 'inviteDate',
      type: 'Timestamp',
      description: 'When the invitation was sent (optional)',
    },
    {
      name: 'role',
      type: 'Member_Role_Enum',
      description:
        "Member's role in the organization: Owner, Admin, Member, or Readonly",
    },
  ]}
/>
