...
| --- | --- | --- |
| `id` | `uuid` | Identifiant unique de l'étape |
| `meetingId` | `uuid` | Référence à la réunion |
| `stepConfigId` | `String` | Référence à la configuration de l'étape dans le stepsConfig de la réunion |
| `type` | `Meeting_Step_Type_Enum` | Type d'étape de réunion |
| `data` | `meeting_step_data` | Données et contenu spécifiques à l'étape |
| `notes` | `String` | Notes et documentation de l'étape |
