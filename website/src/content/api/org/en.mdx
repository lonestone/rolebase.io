...
<EntityFields
  fields={[
    ...
    { name: 'name', type: 'String', description: 'Name of the organization' },
    {
      name: 'slug',
      type: 'String',
      description: 'URL-friendly unique identifier (optional)',
    },
    {
      name: 'archived',
      type: 'Boolean',
      description: 'Whether the organization is archived (default: false)',
    },
    {
      name: 'createdAt',
      type: 'Timestamp',
    ...
    },
    {
      ...
      type: 'String',
      description: 'Default graph view setting (optional)',
    },
    {
