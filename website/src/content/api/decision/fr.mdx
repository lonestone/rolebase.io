  ...
  fields={[
    {
      name: 'id',
      type: 'uuid',
      description: 'Identifiant unique de la décision (généré automatiquement)',
    },
    { name: 'orgId', type: 'uuid', description: "Référence à l'organisation" },
    {
      name: 'circleId',
      type: 'uuid',
      description: 'Référence au cercle où la décision a été prise',
    },
    {
      name: 'memberId',
      type: 'uuid',
      description: 'Référence au membre qui a pris la décision',
    },
    ...
    },
    {
      name: 'archived',
      type: 'Boolean',
      description: 'Indique si la décision est archivée (par défaut : false)',
    },
    {
      name: 'private',
      type: 'Boolean',
      description: 'Indique si la décision est privée (par défaut : false)',
    },
  ]}
/>
