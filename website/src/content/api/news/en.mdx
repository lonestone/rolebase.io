  ...
  fields={[
    {
      name: 'id',
      type: 'uuid',
      description: 'Unique identifier for the news item (auto-generated)',
    },
    {
      name: 'orgId',
      type: 'uuid',
    ...
    },
    {
      name: 'circleId',
      type: 'uuid',
      description: 'Reference to the circle (optional)',
    },
    {
      name: 'threadId',
      type: 'uuid',
      description: 'Reference to the source thread (if applicable)',
    },
    {
      name: 'decisionId',
      type: 'uuid',
      description: 'Reference to the source decision (if applicable)',
    },
    {
      name: 'meetingId',
      type: 'uuid',
      description: 'Reference to the source meeting (if applicable)',
    },
    {
      name: 'createdAt',
      type: 'Timestamp',
      description: 'When the news item was created',
    },
  ]}
/>
