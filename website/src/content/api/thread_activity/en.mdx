  ...
  fields={[
    {
      name: 'id',
      type: 'uuid',
      description: 'Unique identifier for the activity (auto-generated)',
    },
    {
      name: 'threadId',
      type: 'uuid',
    ...
    },
    {
      ...
      description:
        'Type of activity: Message, Poll, Thread, Meeting, Task, Decision, MeetingNote, or ChangeStatus',
    },
    {
      name: 'data',
      type: 'JSON',
      description: 'Activity content (format depends on type)',
    },
    {
      name: 'createdAt',
      type: 'timestamptz',
    ...
    },
    {
      name: 'refThreadId',
      type: 'uuid',
      description: 'Optional reference to another thread',
    },
    {
      name: 'refMeetingId',
      type: 'uuid',
      description: 'Optional reference to a meeting',
    },
    {
      name: 'refTaskId',
      type: 'uuid',
    ...
    },
    {
      name: 'refDecisionId',
      type: 'uuid',
      description: 'Optional reference to a decision',
    },
  ]}
/>
