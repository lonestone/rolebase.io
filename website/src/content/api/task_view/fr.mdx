...
<EntityFields
  fields={[
    ...
    },
    {
      name: 'tasksIds',
      type: 'uuid[]',
      description: "Tableau d'identifiants de tâches incluses dans cette vue",
    },
  ]}
/>
...
<Callout type="info">
  La combinaison de `orgId` et `key` doit être unique. Les identifiants de
  tâches dans la vue doivent correspondre à des tâches existantes dans
  l'organisation. Les vues peuvent être partagées entre les membres de
  l'organisation.
</Callout>
