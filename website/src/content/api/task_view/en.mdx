  ...
  fields={[
    {
      name: 'id',
      type: 'uuid',
      description: 'Unique identifier for the task view (auto-generated)',
    },
    {
      name: 'orgId',
      type: 'uuid',
    ...
    },
    {
      ...
      type: 'String',
      description:
        "Unique key for the view within the organization (e.g., 'backlog', 'sprint')",
    },
    {
      name: 'tasksIds',
      type: 'uuid[]',
      description: 'Array of task IDs included in this view',
    },
  ]}
/>
