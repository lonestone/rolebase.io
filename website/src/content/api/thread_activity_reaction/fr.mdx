  ...
  fields={[
    {
      name: 'id',
      type: 'uuid',
      description: 'Identifiant unique de la réaction (généré automatiquement)',
    },
    {
      name: 'activityId',
      type: 'uuid',
      description: "Référence à l'activité de discussion concernée",
    },
    {
      name: 'userId',
      type: 'uuid',
      description: "Référence à l'utilisateur qui a ajouté la réaction",
    },
    {
      name: 'shortcode',
      type: 'String',
      description: 'Caractère emoji Unicode ou code court',
    },
    {
      name: 'createdAt',
      type: 'Timestamp',
...
<Callout type="info">
  Chaque membre peut ajouter plusieurs réactions emoji différentes à une
  activité, mais les réactions emoji en double du même membre sont empêchées.
  Les réactions sont généralement affichées sous forme de compteurs d'emoji par
  activité et peuvent être utilisées pour des sondages rapides ou le suivi du
  sentiment.
</Callout>
