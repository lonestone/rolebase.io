...
<EntityFields
  fields={[
    ...
    { name: 'circleId', type: 'uuid', description: 'Référence au cercle' },
    {
      ...
      type: 'uuid',
      description: 'Référence au membre qui a initié la discussion',
    },
    ...
    },
    {
      name: 'archived',
      type: 'Boolean',
      description: 'Indique si la discussion est archivée (par défaut : false)',
    },
    {
      name: 'private',
      type: 'Boolean',
      description: 'Indique si la discussion est privée (par défaut : false)',
    },
    {
      name: 'status',
