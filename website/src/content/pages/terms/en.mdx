...
As soon as the data is collected, the Service Provider must inform users of the data processing it intends to carry out. This information is provided through the disclosure of its privacy policy, available at the following address: [https://rolebase.io/en/privacy](/en/privacy).
