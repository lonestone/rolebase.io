...
<Callout type="tip" title="API-Based Migration">
  For large organizations migrating from another tool, writing a script that
  reads your existing data and creates entities via the GraphQL API is the most
  flexible approach.
</Callout>
