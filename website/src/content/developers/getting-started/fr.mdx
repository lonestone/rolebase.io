---
title: 'Premiers pas'
description: 'Configurez votre environnement de développement et lancez Rolebase en local.'
order: 1
---
...
<Callout type="warning" title="Docker requis">
  Nhost exécute ses services backend (PostgreSQL, Hasura, Auth, Storage) dans
  des conteneurs Docker. Assurez-vous que Docker Desktop est en cours
  d'exécution avant de continuer.
</Callout>
...
Puis ouvrez votre navigateur à l'adresse **[http://localhost:5175](http://localhost:5175)**.
...
| `packages/editor`  | Éditeur de texte riche headless (Lexical)     |
