...
Then open your browser at **[http://localhost:5175](http://localhost:5175)**.
...
| `packages/editor`  | Headless rich-text editor (Lexical)          |
| `packages/collab`  | Real-time collaboration server (Yjs)         |
| `packages/emails`  | Transactional email templates (React Email)  |
| `website`          | Marketing and documentation site (Astro)     |
