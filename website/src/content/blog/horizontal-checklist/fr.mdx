...
- **Planification**: Redéfinissez les rôles, établissez des règles de décision décentralisées et choisissez des outils adaptés comme [Rolebase](/) ou [Slack](https://slack.com/).
...
| --------------------- | ------------------------- | --------------------------------------------------------------------------- |
| Définition des postes | Fixes                     | [Rôles basés sur les compétences](/fr/features) |
...
- **[Décisions stratégiques](/fr/features)**: prises par consensus d'équipe.
...
| ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| [Gestion des rôles](/fr/blog/role-based-management) | Rolebase                                                                                     | [Organigrammes dynamiques](/fr/features), suivi des tâches |
