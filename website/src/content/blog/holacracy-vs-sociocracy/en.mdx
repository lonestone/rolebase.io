...
**Holacracy and sociocracy are two [horizontal governance](/en/blog/holacracy-intro) approaches that allow organizations to move away from traditional hierarchical models.**
...
Holacracy emerged from the work of Brian Robertson at [Ternary Software](https://www.facebook.com/ternarysoftware/), a software development company, where he began experimenting with new governance practices in the early 2000s. Inspired by the concept of organization described in Arthur Koestler's writings, Robertson sought to turn it into a concrete method with clear rules. In 2007, he formalized these practices and published the first Holacracy Constitution, creating the system as we know it today.
...
It was in the 1980s that sociocracy took a decisive turn, thanks to Gerard Endenburg. Inspired by these ideas, he transformed his company, [Endenburg Electric](https://www.sociocracy.info/gerard-endenburg/), into a true [sociocratic laboratory](/en/blog/sociocracy-intro) starting in 1970. This model allowed the company to thrive, reaching a turnover of 14 million guilders in 1995, the year Endenburg stepped down.
...
Tech startups and rapidly growing companies often benefit the most. [Zappos](https://www.zappos.com/) is perhaps the most well-known example: in 2013 the company adopted holacracy for its entire workforce. The transition was significant and not without challenges, with about 18% of employees choosing to leave during the reorganization. For Zappos, holacracy brought greater clarity in roles and faster decision-making, though the cultural shift required sustained commitment.

> "Holacracy for an organization is like an Agile way of thinking for a team." - Brian Robertson

However, this model has its limitations. High training costs and the inherent rigidity of the system can be significant obstacles. [Medium](https://medium.com/) experimented with holacracy starting in 2013 but ultimately moved away from it in 2016, finding that it created more process overhead than value for their context. This shows that holacracy works best in organizations that are fully committed to its principles.
...
In a horizontal management model, clarifying roles and responsibilities is often a challenge. To address this, Rolebase offers dynamic and intuitive [org charts](/en/features) that allow you to visualize the distribution of roles within the organization in real time.
...
Horizontal management frameworks often rely on [structured meetings](/en/features). Rolebase offers dedicated tools for organizing [short](/en/features) and focused meetings, while facilitating decision documentation through real-time collaborative editing.
...
The platform also includes integrated task management, allowing you to track actions decided during meetings. A notification system via email ensures that nothing falls through the cracks.
...
To simplify this transition, solutions like Rolebase can support you. This platform offers tools such as dynamic org charts, [structured meeting management](/en/features), and support for remote teams. It also provides organizational audits and coaching to facilitate adoption of the chosen framework.
