...
Also known as the First Link, the Circle Leader role is assigned by the Leader of the parent circle. This person represents the parent circle within the sub-circle and holds the circle's overall purpose.
