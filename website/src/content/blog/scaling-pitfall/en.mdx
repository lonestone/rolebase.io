---
title: 'The no.1 pitfall of business owners when scaling, and how to avoid it'
...
_Rolebase allows you to create and update roles and accountabilities in a few clicks so the process is quick and easy._
...
_Rolebase also allows you to specify decision-making domains for each team, sub-team and roles so people are clear on who's tasked on making what decisions, rather than going around scheduling meetings to approve stuff. _
...
And then each team member gets to answer the following question : '_Do you see a reason serious enough to hurt the business for this proposal \***\*not\*\*** to go through?_'.
...
_Rolebase allows you to document all the decisions the teams have made so they're easy to find._
