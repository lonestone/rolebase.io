...
export const ThreadActivitiesLogsDocument = gql`
  ...
  thread(where: {id: {_eq: $id}}, order_by: {createdAt: asc}, limit: 1) {
    activities {
      ...ThreadActivity
    }
    logs {
